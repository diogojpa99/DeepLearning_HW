...
def main():
    ...
    criterion = nn.CrossEntropyLoss() # Computes softmax and then cross entropy
    ...
    print("-------------- Model --------------")
    print("Classifier:",opt.model)
    print("epochs:",opt.epochs)
    print("Learning_rate:",opt.learning_rate)
    print("hidden_sizes:",opt.hidden_sizes)
    print("dropout:",opt.dropout)
    print("batch_size:",opt.batch_size)
    print("activation:",opt.activation)
    print("optimizer:",opt.optimizer)
    print("l2_decay:",opt.l2_decay)
    print("layers:",opt.layers)
    print("-----------------------------------")
